# -*- encoding: utf-8 -*-
# stub: google-cloud-translate-v2 0.2.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<googleapis-common-protos>.freeze, [">= 1.3.10", "< 2.0"])
    ...
    s.add_dependency(%q<googleapis-common-protos>.freeze, [">= 1.3.10", "< 2.0"])
