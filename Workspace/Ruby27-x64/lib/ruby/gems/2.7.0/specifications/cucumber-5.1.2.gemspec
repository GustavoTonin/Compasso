...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-5.1.2".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<webrick>.freeze, ["~> 1.6", ">= 1.6.0"])
    ...
    s.add_dependency(%q<webrick>.freeze, ["~> 1.6", ">= 1.6.0"])
