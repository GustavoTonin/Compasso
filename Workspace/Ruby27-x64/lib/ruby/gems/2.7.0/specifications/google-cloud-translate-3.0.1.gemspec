# -*- encoding: utf-8 -*-
# stub: google-cloud-translate 3.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<google-cloud-translate-v2>.freeze, ["~> 0.0"])
    s.add_runtime_dependency(%q<google-cloud-translate-v3>.freeze, ["~> 0.0"])
    ...
    s.add_dependency(%q<google-cloud-translate-v2>.freeze, ["~> 0.0"])
    s.add_dependency(%q<google-cloud-translate-v3>.freeze, ["~> 0.0"])
